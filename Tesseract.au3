...
#Region Header
;	Modified by:	Daniel Lu (@dandydanny)
;	Note:			Lovingly modified to work with Tesseract 3 on Windows 7 (32-bit)
;					for use with SV2 Survey Helper
;
#cs
...
func _TesseractScreenCapture($get_last_capture = 0, $delimiter = "", $cleanup = 1, $scale = 2, $left_indent = 0, $top_indent = 0, $right_indent = 0, $bottom_indent = 0, $show_capture = 0)
	...
	ShellExecuteWait("C:\Program Files\Tesseract-OCR\tesseract.exe", $capture_filename & " " & $ocr_filename, "", "", @SW_HIDE)
