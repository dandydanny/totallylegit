...
Local $respondentBank[22][6] = [[], _
		...
		[7, "M", 1994, "LowIncome", "AfricanAmerican", "NoChildren"], _
		[8, "M", 1965, "HighIncome", "Caucasian", "NoChildren"], _
		[9, "F", 1966, "HighIncome", "Asian", "HasChildren"], _
		[10, "M", 1975, "MidIncome", "AfricanAmerican", "NoChildren"], _
		[11, "F", 1980, "MidIncome", "Hispanic", "HasChildren"], _
		[12, "M", 1983, "LowIncome", "Asian", "NoChildren"], _
		[13, "F", 1990, "LowIncome", "Other", "HasChildren"], _
		[14, "M", 1994, "LowIncome", "AfricanAmerican", "NoChildren"], _
		[15, "M", 1965, "HighIncome", "Caucasian", "NoChildren"], _
		[16, "F", 1966, "HighIncome", "Asian", "HasChildren"], _
		[17, "M", 1975, "MidIncome", "AfricanAmerican", "NoChildren"], _
		[18, "F", 1980, "MidIncome", "Hispanic", "HasChildren"], _
		[19, "M", 1983, "LowIncome", "Asian", "NoChildren"], _
		[20, "F", 1990, "LowIncome", "Other", "HasChildren"], _
		[21, "M", 1994, "LowIncome", "AfricanAmerican", "NoChildren"]]
...
$surveyUrl = InputBox("SV2 Flex Survey Helper", "Please enter survey URL (without trackerID):", _
		"http://sv2a-qacore.acemetrix.com/service04/survey-app.html?t=erFxSyc&p=pnt&trackerId=")
...
For $currentRespondentNumber = $loopStart To $loopEnd
	...
	;Respondent vars --------------------------------------------------------
	Local $testTagging = ""
	Local $brandRecResponse = "Corolla A24"
	...
	If $intender = True Then
		...
		MouseMove(351, 160, $mouseSpeed) ;move mouse into next position
		Sleep(1000)
		;351 153
		MouseClick("left", 351, 160, 1)
		MouseMove(900, 525, $mouseSpeed)
		Sleep($smallDelay)
	...
	While 1
		...
		If $attempts > $ocrMaxRetries Then
			...
			Exit
		ElseIf ($captchaNumber < 10) Then
			MsgBox(0, "SV2 Survey Helper", "Please solve captcha manually, then click OK")
			ExitLoop
